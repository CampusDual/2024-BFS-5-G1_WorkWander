import { Component, Inject, Injector, Renderer2, ViewChild } from '@angular/core';
import { MAT_DIALOG_DATA, MatDialogRef } from '@angular/material/dialog';
import { DomSanitizer } from '@angular/platform-browser';
import { ActivatedRoute, Router } from '@angular/router';
import { OntimizeService, OSnackBarConfig, OTextareaInputComponent, OTranslateService, SnackBarService } from 'ontimize-web-ngx';
